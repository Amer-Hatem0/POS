  ...
  return (
    <section id="contact" className="contact section light-background" dir={currentLanguage === 'ar' ? 'rtl' : 'ltr'}>
      <div className="container section-title" data-aos="fade-up">
        <h2>{t.title}</h2>
        {/* عرض الشعار باللغة العربية إذا كانت متاحة، وإلا عرض الإنجليزية */}
        ...
        <div className="row g-4 g-lg-5">
          <div className="col-lg-5">
            <div className="info-box" data-aos="fade-up" data-aos-delay={200}>
              <h3>{t.contactInfo}</h3>
              {/* عرض الوصف باللغة العربية إذا كانت متاحة، وإلا عرض الإنجليزية */}
              ...
              <div className="info-item" data-aos="fade-up" data-aos-delay={300}>
                ...
                <div className="content">
                  ...
                  {/* عرض العنوان باللغة العربية إذا كانت متاحة، وإلا عرض الإنجليزية */}
