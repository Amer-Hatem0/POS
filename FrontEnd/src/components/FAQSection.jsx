...
const FAQSection = () => {
  ...
  const fetchFaqs = async () => {
    try {
      ...
      // Filter active FAQs, sort by displayOrder, and limit to 5
        ...
        <div className="row">
          <div className="col-lg-5" data-aos="fade-up">
            ...
            <p className="faq-description">
              Find answers to the most common questions about our services and company policies.
            </p>
...
//     try {
//       const res = await api.get('/FAQ');
//       // Filter active FAQs, sort by displayOrder, and limit to 6
//       const activeFaqs = res.data
//         .filter((faq) => faq.isActive)
//         .sort((a, b) => a.displayOrder - b.displayOrder)
//         .slice(0, 6);
