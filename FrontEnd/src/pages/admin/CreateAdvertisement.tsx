                    ...
                    <div className="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div className="d-flex gap-2">
                            <Link to={`/admin/ad/${a.id}`}>
                                <Button variant="outline" className="bg-green-100 text-black hover:bg-green-300" title="View">View</Button>
                            </Link>
                            <Button
                                onClick={() => togglePublish(a)}
                                title={a.isPublished ? "Unpublish" : "Publish"}
                                className={a.isPublished ? "bg-green-500 hover:bg-green-600 text-white" : "bg-red-500 hover:bg-red-600 text-white"}
                            >
